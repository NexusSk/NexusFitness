      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="inline-flex items-center gap-2 mb-12 animate-fade-in-up">
            ...
            <span className="text-sm font-medium text-gray-400 uppercase tracking-wider">Premium Fitness</span>
          ...
          <p className="text-lg md:text-xl mb-12 text-gray-400 max-w-2xl mx-auto font-light leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Join thousands achieving their fitness goals at Nexus Fitness. 
            State-of-the-art equipment, expert trainers, supportive community.
          </p>
